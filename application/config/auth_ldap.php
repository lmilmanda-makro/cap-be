...
/**
 * Array Index      - Usage (&(member=CN=Leandro Milmanda,OU=Users,OU=Sistemas,OU=HO,OU=Makro,OU=Argentina,DC=makro,DC=com,DC=ar)(objectClass=group))
 * (memberOf=CN=SVN Access,CN=Users,DC=makro,DC=com,DC=ar)
    OU=Users,OU=Sistemas,OU=HO,OU=Makro,OU=Argentina,DC=makro,DC=com,DC=ar
   (memberOf=CN=OTRSAgents,CN=Users,DC=makro,DC=com,DC=ar)
 ...
 */
$config['ad_domain'] = 'ldap.makro.com.ar';	
$config['hosts'] = array('ldap.makro.com.ar');
$config['ports'] = array(389);

$config['proxy_user'] = 'CN=OTRS - HelpDesk,CN=Users,DC=makro,DC=com,DC=ar';
$config['proxy_pass'] = 'QL4iuFtb927lYClkac9ae';

$config['basedn'] = 'OU=Argentina,DC=makro,DC=com,DC=ar';
$config['groupdn'] = 'CN=OTRSAgents,CN=Users,DC=makro,DC=com,DC=ar';
